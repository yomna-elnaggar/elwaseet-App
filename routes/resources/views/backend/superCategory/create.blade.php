                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item">تصنيف عام</li>
                            <li class="breadcrumb-item active"> اضافة تصنيف عام</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('SuperCategory.store') }}" method="post" class="needs-validation" enctype="multipart/form-data">
                                @csrf
