        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('subcategory.update', $subcategory->id) }}" method="post" class="needs-validation" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-select" aria-label="Disabled select example" name="supercategory_id"  onchange="console.log($(this).val())">
                                            <option value="{{ $subcategory->superCategory->id  }}" selected>  {{  $subcategory->superCategory->name('ar') }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" id="validationCustom1" type="text" name="name_ar"
                                            required="" value="{{$subcategory->name('ar')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="validationCustom1" class="col-xl-3 col-md-4"><span>*</span>اسم
                                        التصنيف(english)</label>
                                    <div class="col-md-8">
                                        <input class="form-control" id="validationCustom1" type="text" name="name_en"
                                            required="" value="{{$subcategory->name('en')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
